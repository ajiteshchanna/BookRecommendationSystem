...
class DataIngestion:
    ...
    def download_data(self):
        ...
        """
        try:
            # first of all we are creating the zip directory
    ...
    def extract_zip_file(self,zip_file_path: str):
        ...
        try:
            ...
            # here, we are doing the unzip operation
    ...
    def initiate_data_ingestion(self):
        try:
            ...
            # first of all we are running the download data
            zip_file_path = self.download_data()

            # then we are unzipping the file
            self.extract_zip_file(zip_file_path=zip_file_path)

            # then we are logging the info 
